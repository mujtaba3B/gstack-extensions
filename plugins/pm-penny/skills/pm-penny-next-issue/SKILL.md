...
description: >
  ...
  "triage the backlog", "/pm-penny-next-issue", or otherwise asks for a
  recommendation on what to grab from open issues. Use this skill — not
  pm-penny-feature or pm-penny-bug — when the work already exists as an issue
