...
- **copy-editing** (`marketing:copy-editing`): For polishing existing copy (use after your draft)
- **stop-slop** (`marketing:stop-slop`): Run on every draft to remove AI writing patterns
