...
3. **idle_timeout default flipped to stop**: long silence after watcher start is overwhelmingly "CR is done"; the user can re-invoke /pr-watcher when they push again. Keeping the watcher alive by default just produced more stale sessions.
