...
|---|---|---|
| `ship-pr-gate.sh` | PreToolUse Bash | Blocks a bare `gh pr create` in a gated repo (default-on fleet-wide) unless a fresh `/ship` sentinel proves the create is part of a real `/ship` run. |
