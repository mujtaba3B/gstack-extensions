...
**Read first:** Load `shared/core.md` (Engineer Earnie's identity and how he thinks about review) and `shared/review-engine.md` (the multi-lens review machinery: locate toolkit, depth tiers, lenses, verify-don't-trust). This skill is the *orchestrator*; `review-engine.md` is *how a review runs*.
