...
- **Marketing Mindy** (`marketing/`): marketing persona. `/marketing:copywriting`, `/marketing:copy-editing`, `/marketing:stop-slop`. Owns marketing surfaces; today the basket is copywriting (draft, de-slop, then polish), with room to grow into the wider marketing toolkit (CRO, ads, email, SEO). Skills are vendored from third-party MIT repos (Corey Haines' marketingskills, Hardik Pandya's stop-slop) at pinned SHAs and patched for local voice rules; `marketing/VENDORED.md` carries provenance and the update play.
